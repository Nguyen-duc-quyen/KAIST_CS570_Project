...
from pipelines.consistency_pipeline import ConsistencyModelTrainingPipeline
...
def main(cfg):
    ...
    # Training Pipeline
    consistency_trainer = ConsistencyModelTrainingPipeline(
        model=model,
