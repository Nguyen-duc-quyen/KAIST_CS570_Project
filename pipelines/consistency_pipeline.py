...
class ConsistencyModelPipeline(L.LightningModule):
    """
        Consistency Model Training Pipeline
    """
    def __init__(
        self,
        model,
    ...
    def on_train_epoch_end(self):
        ...
        """
        avg_epoch_loss = self.running_loss/self.num_step
    ...
    def on_validation_epoch_end(self):
        ...
        # Sampling steps
        with torch.no_grad():
            sampling_steps = list(reversed(range(self.noise_scheduler.num_train_timesteps)))
    ...
    def sample(self, num_samples, num_inference_steps=None):
        if num_inference_steps == None:
            print("[INFO]: Using the default number of steps: {}".format(self.noise_scheduler.num_train_timesteps))
        else:
            print("[INFO]: Switching from {} steps to {} steps.".format(self.noise_scheduler.num_train_timesteps, num_inference_steps))
...
class ConsistencyDistillationPipeline(L.LightningModule):
    """
